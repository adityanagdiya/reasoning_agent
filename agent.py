...
11. **Parallel Execution Order**:
    *   If a single node has MULTIPLE outgoing edges (parallel execution), and <<<"if there is need to define an execution order">>> then you MUST define an execution order.
